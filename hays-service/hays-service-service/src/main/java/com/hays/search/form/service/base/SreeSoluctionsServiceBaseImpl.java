...
import com.hays.search.form.service.SreeSoluctionsService;
...
/**
 * Provides the base implementation for the sree soluctions remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.hays.search.form.service.impl.SreeSoluctionsServiceImpl}.
 * </p>
 *
 * @author Sreenivasulu
 ...
 * @generated
 */
public abstract class SreeSoluctionsServiceBaseImpl extends BaseServiceImpl
	implements SreeSoluctionsService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.hays.search.form.service.SreeSoluctionsServiceUtil} to access the sree soluctions remote service.
	 */
	 ...
	 */
	public com.hays.search.form.service.EmployeeService getEmployeeService() {
	...
	public void setEmployeeService(
		com.hays.search.form.service.EmployeeService employeeService) {
	 ...
	 */
	public com.hays.search.form.service.SreeSoluctionsLocalService getSreeSoluctionsLocalService() {
	...
	public void setSreeSoluctionsLocalService(
		com.hays.search.form.service.SreeSoluctionsLocalService sreeSoluctionsLocalService) {
		this.sreeSoluctionsLocalService = sreeSoluctionsLocalService;
	}

	/**
	 * Returns the sree soluctions remote service.
	 *
	 * @return the sree soluctions remote service
	 */
	public SreeSoluctionsService getSreeSoluctionsService() {
		return sreeSoluctionsService;
	}

	/**
	 * Sets the sree soluctions remote service.
	 *
	 * @param sreeSoluctionsService the sree soluctions remote service
	 */
	public void setSreeSoluctionsService(
		SreeSoluctionsService sreeSoluctionsService) {
		this.sreeSoluctionsService = sreeSoluctionsService;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SreeSoluctionsService.class.getName();
	}
	...
	@BeanReference(type = com.hays.search.form.service.EmployeeService.class)
	protected com.hays.search.form.service.EmployeeService employeeService;
	@BeanReference(type = EmployeePersistence.class)
	protected EmployeePersistence employeePersistence;
	@BeanReference(type = EmployeeFinder.class)
	protected EmployeeFinder employeeFinder;
	@BeanReference(type = com.hays.search.form.service.SreeSoluctionsLocalService.class)
	protected com.hays.search.form.service.SreeSoluctionsLocalService sreeSoluctionsLocalService;
	@BeanReference(type = SreeSoluctionsService.class)
	protected SreeSoluctionsService sreeSoluctionsService;
